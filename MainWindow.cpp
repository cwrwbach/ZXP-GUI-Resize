...
//QObject::connect(ui->setupRsp, SIGNAL(clicked()), this, SLOT(hardware_setup())); //FIXME
...
*/
  //  ui->alpha_plotter->draw_trace(fft_video_buf,0,1024,-1500,-200); //(left,Num points,lower,upper) //FIXME
